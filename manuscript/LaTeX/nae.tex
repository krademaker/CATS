...
\def\@maketitle{%
  ...
  \parbox[b]{415pt}{\raggedleft{\helveticacnitalic\fontsize{8}{12}\selectfont {Vrije Universiteit Amsterdam}}\\[1pt]
  {\helveticacn Faculty of Science}\\[1pt]
  {\ifx\@access\@empty
  \else
...
%  }
  \hfill\includegraphics{CATS assignment/final-paper/cabios-template/images/griff-blauw_1_25.png}}
  \vskip2pt
  \rule{415pt}{2\p@}\par%
  \helvetica
  \hbox to \textwidth{%
